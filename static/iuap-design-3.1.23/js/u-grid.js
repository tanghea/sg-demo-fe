...
/***/ function(module, exports) {
	...
	var getLocalData = function getLocalData() {
		...
		if (this.$sd_storageData != null) return this.$sd_storageData;else {
			...
			if (typeof JSON == "undefined") this.$sd_storageData = JSON.parse(storageDataStr);else this.$sd_storageData = JSON.parse(storageDataStr);
			// if (typeof JSON == "undefined") this.$sd_storageData = eval("(" + storageDataStr + ")");else this.$sd_storageData = JSON.parse(storageDataStr);
			// if (typeof JSON == "undefined") this.$sd_storageData =  storageDataStr ;else this.$sd_storageData = JSON.parse(storageDataStr);

...
interface_file.prototype = {
    ...
    * @param callback  回调函数
    */
	filesystem_uploadWithSign: function(parameter,callback) {
		interface_file.uploadWithSign(parameter,callback);
	},
	...
	*/
	 ...
	 * 复制附件
	 */
	filesystem_copy:function(parameter,callback) {
		interface_file.copy(parameter, callback);
	},
	/**
	* 删除方法
    * @param parameter 必要参数
